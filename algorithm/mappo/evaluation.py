"""Deterministic MAPPO evaluation against the canonical Blue strategy."""
...
def evaluate_actor(actor: GaussianActor, env_config: str | Path | Mapping[str, Any] | None, episodes: int, profile: str, seed: int = 1000, device: str = "cpu") -> list[dict[str, Any]]:
    records = []
