...
def _summarize(records: list[dict[str, Any]], elapsed: float) -> dict[str, Any]:
    ...
    base = {
        ...
        "mean_red_attack_deaths": float(np.mean([r["red_attack_deaths"] for r in records])),
        "mean_blue_attack_deaths": float(np.mean([r["blue_attack_deaths"] for r in records])),
        ...
        while len(records) < episodes:
            ...
            for i in done_idx:
                records.append({
                    ...
                    "red_attack_deaths": int(result.episode_red_attack_deaths[i]),
                    "blue_attack_deaths": int(result.episode_blue_attack_deaths[i]),
