...
CONTROL_DIAGNOSTIC_KEYS: list[str] = [
    ...
    "action_pitch",
    "action_speed",
    "normalized_action_yaw",
    "normalized_action_pitch",
    "normalized_action_speed",
    "delta_yaw",
    "delta_pitch",
    "delta_speed",
    "effective_yaw_delta",
    "effective_pitch_delta",
    "effective_speed_delta",
    "requested_yaw_rate",
    "requested_pitch_rate",
    "requested_acceleration",
    "requested_yaw_rate_fraction",
    "requested_pitch_rate_fraction",
    "requested_acceleration_fraction",
    "command_yaw_rate_saturated",
    "command_pitch_rate_saturated",
    "command_acceleration_saturated",
