...
R-HAPPO is the recurrent-actor baseline for the frozen v3.2 environment contract. It does not change environment dynamics, combat, reward, sensing, the 100D actor observation, or the 117D centralized state.
